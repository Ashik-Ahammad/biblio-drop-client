    ...
    <div className="min-h-screen p-4 md:p-6 bg-[#050505]">
      ...
      >
        <div className="mb-8">
          ...
          <p className="text-neutral-400 mt-1">Monitor all platform orders, user purchases, and delivery statuses.</p>
        </div>
        ...
        <div className="bg-gradient-to-b from-[#111111] to-[#0a0a0a] border border-white/10 rounded-2xl shadow-2xl overflow-hidden flex flex-col">
          <Table aria-label="Transactions Table" className="bg-transparent flex-1">
            <Table.ScrollContainer className="overflow-x-auto scrollbar-hide">
              <Table.Content className="min-w-[1000px] w-full text-left border-collapse">
                <Table.Header className="bg-[#1a1a1a] border-b border-white/10">
                  <Table.Column className="p-4 text-xs font-semibold text-neutral-400 uppercase tracking-wider">Order ID</Table.Column>
                  <Table.Column className="p-4 text-xs font-semibold text-neutral-400 uppercase tracking-wider">Customer Details</Table.Column>
                  <Table.Column className="p-4 text-xs font-semibold text-neutral-400 uppercase tracking-wider">Librarian Details</Table.Column>
                  <Table.Column className="p-4 text-xs font-semibold text-neutral-400 uppercase tracking-wider w-[25%]">Book Info</Table.Column>
                  <Table.Column className="p-4 text-xs font-semibold text-neutral-400 uppercase tracking-wider">Amount</Table.Column>
                  <Table.Column className="p-4 text-xs font-semibold text-neutral-400 uppercase tracking-wider">Date & Time</Table.Column>
                ...
                <Table.Body>
                  {paginatedOrders.map((order) => {
                    ...
                    return (
                      <Table.Row key={order._id} className="border-b border-white/5 hover:bg-white/[0.03] transition-colors">
                        ...
                        <Table.Cell className="p-4">
                          <div className="flex flex-col">
                            <span className="font-bold text-neutral-100 text-sm truncate max-w-[180px]">
                        ...
                        <Table.Cell className="p-4">
                          <div className="flex flex-col">
                            <span className="font-bold text-neutral-200 text-sm capitalize truncate max-w-[180px]">
                              {librarianName}
                            </span>
                            <span className="text-xs text-neutral-500 mt-0.5 truncate max-w-[180px]">
                        ...
                        <Table.Cell className="p-4">
                          <div className="flex flex-col">
                            <span className="font-bold text-white text-sm truncate max-w-[250px]">
                        ...
                        <Table.Cell className="p-4">
                          <div className={`inline-flex items-center gap-1.5 px-3 py-1 rounded-full text-xs font-bold tracking-wide border ${getStatusStyles(order.status)}`}>
          ...
          {totalItems === 0 && (
            <div className="py-20 text-center">
              <ReceiptText className="mx-auto text-neutral-700 mb-4" size={48} />
              <h3 className="text-neutral-200 font-semibold text-lg">No transactions found</h3>
