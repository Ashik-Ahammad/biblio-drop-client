      ...
      <div className="max-w-7xl mx-auto px-4 md:px-8 relative z-10">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 xl:gap-24 mb-20">
          ...
          <div className="lg:col-span-5 flex justify-center lg:justify-start">
            ...
            <div className="w-full max-w-[320px] sm:max-w-[380px] lg:max-w-[420px] mx-auto lg:mx-0 perspective-[1000px] group">
              ...
              <div className="relative w-full aspect-[2/3]">
                ...
                {/* Stacked Card 1 (Right offset - Back) */}
                ...
                {/* Stacked Card 2 (Left offset - Middle) */}
          ...
          <div className="lg:col-span-7 flex flex-col justify-center">
            ...
            <p className="text-xl md:text-2xl text-neutral-500 dark:text-neutral-400 mb-8 font-medium">
              Written by{" "}
            ...
            {/* Interactive Action Card (Pricing & Buttons) */}
