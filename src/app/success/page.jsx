  ...
  return (
    <main className="min-h-screen bg-[#000000] text-white flex items-center justify-center p-4 font-sans">
      <div className="bg-white/5 border border-white/10 rounded-3xl p-10 max-w-lg text-center backdrop-blur-3xl shadow-2xl">
        ...
        <h1 className="text-3xl font-bold mb-4 text-emerald-400">Order Placed Successfully!</h1>
        <p className="text-neutral-400 mb-8 leading-relaxed font-light">
          We received your delivery request. The data has been securely saved under your profile, and the book status is now updated to <b>Pending Delivery</b>.
        </p>
        <Link href="/books" className="px-6 py-3 bg-white text-black font-bold rounded-xl hover:bg-neutral-200 transition-all">
          Browse More Books
        </Link>
      </div>
    </main>
