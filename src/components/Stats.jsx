...
export default function Stats() {
  const statsData = [
    { icon: LibraryBig, label: "Total Books", target: 15000, suffix: "+" },
    { icon: Users, label: "Active Readers", target: 8500, suffix: "+" },
    { icon: BookOpenCheck, label: "Books Ordered", target: 45000, suffix: "+" },
  ];
