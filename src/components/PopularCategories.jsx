      ...
      <div className="flex flex-col items-center justify-center text-center mb-16">
        ...
        >
          <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-emerald-500/10 border border-emerald-500/20 mb-6">
            ...
            <span className="text-emerald-400 font-medium text-xs tracking-widest uppercase">
              Book Categories 
            </span>
          </div>
            ...
            <motion.div key={cat.key} variants={itemVariants}>
              <Link href="/books" className="block h-full">
                <motion.div
                  ...
                  whileTap={{ scale: 0.98 }}
                  className="group relative h-full flex flex-col items-center justify-center p-6 sm:p-8 rounded-2xl bg-[#0a0c10] border border-white/5 overflow-hidden transition-all duration-500 hover:border-white/10 hover:shadow-2xl hover:shadow-black/50"
                >
                  ...
                  <div className="relative z-10 mb-4 p-4 rounded-full bg-white/5 ring-1 ring-white/10 group-hover:bg-white/10 transition-colors duration-500">
                    <Icon
                      className="w-6 h-6 sm:w-8 sm:h-8 text-zinc-300 group-hover:text-white transition-colors duration-500"
                      strokeWidth={1.5}
                    />
                  </div>

                  <div className="relative z-10 text-center flex flex-col gap-1">
                    <h3 className="text-sm sm:text-base font-semibold text-zinc-300 group-hover:text-white transition-colors duration-500">
                      {cat.label}
                    </h3>

                    <span className="text-xs font-medium text-zinc-500 group-hover:text-zinc-300 transition-colors duration-500">
