          ...
          <SwiperSlide key={slide.id} className="relative overflow-hidden">
            ...
            <div className="relative z-10 flex flex-col items-center justify-center h-full px-4 text-center mx-auto max-w-5xl">
              <motion.div
                ...
                className="mb-4 inline-flex items-center gap-2 bg-black/10 dark:bg-white/10 backdrop-blur-md border border-black/10 dark:border-white/20 text-white dark:text-white/80 text-xs font-semibold px-4 py-1.5 rounded-full transition-colors opacity-0 animate-fade-in-up"
              >
              ...
              <motion.h1
                ...
                className="text-4xl md:text-6xl lg:text-7xl font-black tracking-tight text-white mb-5 leading-tight drop-shadow-lg opacity-0 animate-fade-in-up"
              ...
              <motion.p
                ...
                className="text-base md:text-lg lg:text-xl text-white mb-10 max-w-2xl leading-relaxed font-medium drop-shadow-md opacity-0 animate-fade-in-up"
