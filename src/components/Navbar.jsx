            ...
            <div className="hidden md:flex items-center gap-4">
              {!user ? (
                <>
                  <Link
                    href="/signin"
                    className="font-medium text-gray-300 hover:text-emerald-400 transition-colors px-4"
                  >
                    Sign In
                  </Link>
                  <Link href="/signup">
                ...
                <Dropdown>
                  <Dropdown.Trigger className="cursor-pointer rounded-full transition-transform hover:scale-105">
                    <Avatar
                      size="sm"
                      isBordered
                      className="ring-2 ring-offset-2 ring-offset-[#0a0a0a] ring-emerald-500/50"
                    >
                      <Avatar.Image src={user.image} alt={user.name} />
                      <Avatar.Fallback
                        delayMs={600}
                        className="bg-emerald-900/50 text-emerald-500 font-bold"
                      >
                        {initials}
                      </Avatar.Fallback>
                    </Avatar>
                  ...
                  <Dropdown.Popover className="bg-[#121212] border border-white/10 text-white shadow-2xl rounded-2xl min-w-60">
                    <div className="px-4 pt-4 pb-2 border-b border-white/5">
                      <div className="flex items-center gap-3">
                        ...
                        <div className="flex flex-col gap-0">
                          ...
                          <p className="text-xs leading-none text-neutral-400 truncate w-40">
                            {user.email}
                          </p>
                    ...
                    <Dropdown.Menu className="p-2">
                      <Dropdown.Item
                        ...
                        className="hover:bg-emerald-500/10 rounded-xl transition-colors"
                      >
                        <div className="flex w-full items-center justify-between gap-2 py-1">
                          <Label className="cursor-pointer text-sm font-medium text-neutral-300">
                            Dashboard
                          </Label>
                      ...
                      <Dropdown.Item
                        ...
                        className="mt-1 hover:bg-red-500/10 rounded-xl transition-colors"
                      >
                        <div className="flex w-full items-center justify-between gap-2 py-1">
                          <Label className="cursor-pointer text-sm font-medium text-red-400">
                            Sign Out
                          </Label>
              ...
              {!user ? (
                <div className="flex flex-col gap-3 px-2">
                  <Link href="/signin" onClick={() => setIsMenuOpen(false)}>
                    <Button
                      variant="bordered"
                      className="w-full font-semibold border-white/20 text-white rounded-xl h-12"
                    >
                      Sign In
                    </Button>
                  </Link>
